...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-network-info/react_native_network_info.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-version-number/react_native_version_number.framework"
